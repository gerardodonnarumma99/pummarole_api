 ...
 */
final class Version20200318190552 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX timer_type ON timers (timer_type)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX timer_type ON timers');
